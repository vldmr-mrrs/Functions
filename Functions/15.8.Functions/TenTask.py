...
ints = list(filter(lambda x: x if type(x) == int else None, mixed_list))
strings = list(filter(lambda x: x if type(x) == str else None, mixed_list))

res = sorted(ints) + sorted(strings)
print(*res, sep=' ')
